    ...
    <div style="padding:32px;">
      <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:12px;padding:20px;margin-bottom:28px;">
        <table style="width:100%;font-size:14px;border-collapse:collapse;">
          ...
          <tr><td style="color:#6b7280;padding:4px 0;">Pickup Location</td><td style="color:#111827;font-weight:600;text-align:right;">${booking.pickup_location || 'Panama City'}</td></tr>
