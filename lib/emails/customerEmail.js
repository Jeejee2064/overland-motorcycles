          ...
          <div class="section">
            ...
            <div class="detail-row">
              ...
              <span class="detail-value">
                ${booking.paid
                  ? `<span class="highlight">$${booking.down_payment.toFixed(2)} PAID ✓</span>`
                  : `$${booking.down_payment.toFixed(2)} <span style="background:#FEF3C7;color:#92400E;padding:2px 8px;border-radius:4px;font-size:12px;font-weight:600;">PENDING</span>`
                }
              </span>
            </div>` : ''}
            <div class="detail-row">
