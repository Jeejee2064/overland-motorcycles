          ...
          <div class="section">
            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                ...
                <div class="info-value" style="font-size: 13px;">${booking.pickup_location || 'Panama City'}</div>
              </div>
            </div>
          </div>
          ...
          <div class="section">
            <div class="checklist">
              ...
              <ul>
                ...
                <li>Pickup location: <strong>${booking.pickup_location || 'Panama City'}</strong></li>
